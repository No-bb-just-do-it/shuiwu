...
class JiangSu(TaxConfig):
    def __init__(self):
        super(JiangSu,self).__init__()
        self.session = None
        self.province = "江苏省"
        self.log_name = 'JiangSu.log'
        self.path = self.get_savefile_directory('JiangSu')
    ...
    def qs_abnormal_province(self):
        ...
        # for q in ['欠税']:
            for p in range(1,7):
                ...
                url_start = 'http://www.jsgs.gov.cn/jrobot/search.do'
