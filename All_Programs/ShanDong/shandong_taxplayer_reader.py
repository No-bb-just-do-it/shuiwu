...
class ZheJiangTaxplayerReader(TaxplayerReader):
    ...
    def abnormal_html_reader(self):
        ...
        for num_info in range(0, len(info)):
            ...
            if tr_list:
                match_fields, judge = self.get_html_abnormal_field_info(tr_list, fields)
                if judge:
                    new_tr_list = tr_list[2:]
                else:
                    new_tr_list = tr_list[1:]
                if match_fields:
                    self.log(str(num_info+1) + ' ' + str(match_fields))
                        ...
                        for j in range(start_idx, rows):
                            ...
                            for md in range(len(match_fields)):
                                ...
                                if key in int_fields:
                                    ...
                                    if type(row_val_new) == unicode:
                                        if not re.findall(u'\d+', row_val_new) or qsje_condition:
                                            break
                                        else:
                                        ...
                                        if len(td_texts) >= len(match_fields):
                                            ...
                                            for md in range(len(match_fields)):
                                                ...
                                                if key in money_fields:
                                                    ...
                                                    if not re.findall(u'\d+', temp_val) or qsje_condition:
                                                        break
                                            ...
                                            for md in range(len(match_fields)):
                                                ...
                                                if key in hb_fields:
                                                    ...
                                                    if key in money_fields:
                                                        ...
                                                        if not re.findall('\d+', val) or qsje_condition:
                                                            break
                                                        val = self.get_money_field(val, wan)
                                                        field_keys += key + ','
                                                        keys.append(key)
    ...
    def qsgg_html_reader(self):
        ...
        for num_info in range(0, len(info)):
            ...
            if tr_list:
                match_fields, wan = self.get_html_qsgg_field_info(tr_list, fields)
                new_tr_list = tr_list[1:]
                for td in new_tr_list[0].findAll('td'):
                    print td.text
                if match_fields:
                    self.log(str(num_info+1) + ' ' + str(match_fields) + str(wan))
                    if len(match_fields) < 3:
