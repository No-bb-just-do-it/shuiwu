...
class JiangXiTaxplayerReader(TaxplayerReader):
    def __init__(self):
        super(JiangXiTaxplayerReader, self).__init__()
        self.province = u'江西省'
        self.province_py = 'Jiang_Xi'
        self.set_config()
...
if __name__ == '__main__':
    # for i in ['%2017-10-27%','%2017-10-30%','%2017-10-31%','%2017-11-01%','%2017-11-02%','%2017-11-08%','%2017-11-20%', \
    #           '%2017-11-22%','%2017-11-27%','%2017-11-29%','%2017-12-04%','%2017-12-06%','%2017-12-11%']:
        reader = JiangXiTaxplayerReader()
        # reader.today = "'" + str(i) + "'"
        reader.word_to_html()
